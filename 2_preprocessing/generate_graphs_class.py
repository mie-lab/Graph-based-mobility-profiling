...
for study in studies:
    ...
    for user_id_this in locs["user_id"].unique():
        ...
        AG.plot(os.path.join(".", "graph_images", "new", study, "spring", str(user_id_this)),
                filter_node_importance=25, draw_edge_label=False)
        AG.plot(os.path.join(".", "graph_images", "new", study, "coords", str(user_id_this)),
                filter_node_importance=25, draw_edge_label=False, layout='coordinate')
