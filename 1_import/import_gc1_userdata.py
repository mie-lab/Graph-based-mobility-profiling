...
columns_to_drop = ['workaddress', 'homeaddress', 'work_lon', 'work_lat',
       'home_lon', 'home_lat', 'homebfs', 'workbfs', 'work_pc1', 'work_pc2',
       'work_pc3', 'work_pc4', 'pc1', 'pc2', 'pc3', 'pc4', 'geom_home', 'geom_work']
